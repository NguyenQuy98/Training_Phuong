					...
					<!-- item blog -->
						@foreach($blogs as $blog)
							...
							<div class="item-blog p-b-80">
								<a href="{{ route('guest.blog_detail')}}" class="item-blog-img pos-relative dis-block hov-img-zoom">
								...
								<div class="item-blog-txt p-t-33">
									<h4 class="p-b-11">
										<a href="{{ route('guest.blog_detail')}}" class="m-text24">
											{{$blog->title}}
										</a>
									</h4>
									...
									<a href="{{ route('guest.blog_detail')}}" class="s-text20">
										Continue Reading
